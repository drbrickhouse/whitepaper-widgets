...
function whitepaper_widgets_parse_handlebars( array $matches = array() ) {
...
function whitepaper_widgets_handlebars($field) {
	$value = preg_replace_callback( '#\{{(.*)\}}#Ui', 'whitepaper_widgets_parse_handlebars', $field);
	if ( file_exists( get_stylesheet_directory() . '/inc/whitepaper_custom_handlebars.php' ) ) {
